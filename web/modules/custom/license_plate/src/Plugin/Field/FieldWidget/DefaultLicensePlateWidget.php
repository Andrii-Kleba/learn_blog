...
class DefaultLicensePlateWidget extends WidgetBase {
  ...
  public function settingsForm(array $form, FormStateInterface $form_state): array {
    ...
    $elements['field_state'] = [
      ...
      '#description' => $this->t('The default state of the fieldset which contains the two plate field: open or closed.'),
    ];

    $elements['placeholder'] = [
      '#type' => 'details',
      '#title' => $this->t('Placeholder'),
      '#description' => $this->t('Text that will be shown inside the field
                                        until a value is entered. This hint is usually a sample value or a brief
  ...
  public function settingsSummary(): array {
    ...
    $summary[] = $this->t('Field state: @state', ['@state' => $this->getSetting('fieldset_state')]);
   ...
   * {inheritdoc}
   */
  public function messageFromValues(array $values, array $form, FormStateInterface $form_state): array {
