...
class BlogHeroBlock extends BlockBase implements ContainerFactoryPluginInterface {
   ...
   *
   * @var \Drupal\dlog_hero\Plugin\BlogHeroPluginManager
   */
   ...
   * @param \Drupal\dlog_hero\Plugin\BlogHeroPluginManager $blog_hero_entity
   *   The plugin manager for dlog hero entity plugins.
   * @param \Drupal\dlog_hero\Plugin\BlogHeroPluginManager $blog_hero_path
